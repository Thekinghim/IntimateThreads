          ...
          <div className="mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
              ...
              <Link href="/how-it-works">
                <Button variant="outline" size="lg" className="bg-[#fbf9f4] border-2 border-[#064F8C] text-[#064F8C] hover:bg-[#064F8C] hover:text-[#FEFBEA] font-medium px-12 py-6 text-xl rounded-3xl transition-all duration-500 hover:scale-105">
                  Så Fungerar Det
                </Button>
              </Link>
            </div>
